       ...
       (let ((sn '(v l)))
         `(defun ,name (h s ,(nth n sn))
            ...
            (let* ((h (mod h 360))      ; 360 == 0
                   ...
                   (g nil)
                   (b nil))
              (cond ((and (<= 0 h) (< h 60)) (setf r c g x b 0))
                    ((and (<= 60 h) (< h 120)) (setf r x g c b 0))
                    ((and (<= 120 h) (< h 180)) (setf r 0 g c b x))
                    ((and (<= 180 h) (< h 240)) (setf r 0 g x b c))
                    ((and (<= 240 h) (< h 300)) (setf r x g 0 b c))
                    ((and (<= 300 h) (< h 360)) (setf r c g 0 b x)))
              (let ((red (* (+ r m) 255))
                    (green (* (+ g m) 255))
                    (blue (* (+ b m) 255)))
